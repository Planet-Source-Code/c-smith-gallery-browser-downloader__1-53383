...
Begin VB.Form frmShowDefsO 
   ...
   End
End
Attribute VB_Name = "frmShowDefsO"
...
End If
txtDelay.SetFocus
SaveSetting App.Title, "Settings", "ODirection", cmdDirection.Caption
...
FormOnTop Me
frmOnline.tmr.Interval = txtDelay * 1000
...
End If
frmOnline.tmr.Interval = txtDelay * 1000
SaveSetting App.Title, "Settings", "ODelay", txtDelay.Text
End Sub
